...
//   brightness: 100, // percentage
  ...
  setPowerOn1: function(on) { 
    ...
    var cmd="ON";
    if (on) cmd="OF";
    RELAY_BOARD.sp.write("@00"+cmd+"1\r", function(err, results) {
        console.log('err ' + err);
...
RELAY_BOARD.sp = new serialport.SerialPort("/dev/tty.usbserial-A60155HS", {
	baudrate: 9600,
...
var lightUUID = uuid.generate('hap-nodejs:accessories:relayboard');
...
light
  ...
  .setCharacteristic(Characteristic.Model, "KTA-223 RelayBoard")
